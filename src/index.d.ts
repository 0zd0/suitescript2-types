...
declare global {
    export interface NetSuiteModuleTypesMap {
    ...
    export type NetSuiteModuleTypes<T extends readonly string[]> = {
        [K in keyof T]: T[K] extends keyof NetSuiteModuleTypesMap ? NetSuiteModuleTypesMap[T[K]] : never;
    }

    function define<T extends string[]>(deps: [...T], callback: (...args: NetSuiteModuleTypes<T>) => CallbackReturn): void;
    function require<T extends string[]>(deps: [...T], callback: (...args: NetSuiteModuleTypes<T>) => void): void;
